...
public class ItemsPage extends AbstractPage {
    ...
    public void assertButtons(int deleteButtonsCount, int editButtonsCount, int addButtonsCount, int likeButtonsCount) {
        Assertions.assertEquals("delete btn count", deleteButtonsCount, this.getDeleteButtons().size());
        Assertions.assertEquals("edit btn count", editButtonsCount, this.getEditButtons().size());
        Assertions.assertEquals("add btn count", addButtonsCount, this.getAddEventButton().size());
        Assertions.assertEquals("follow btn count", likeButtonsCount, this.getFollowButton().size());
    }

    public boolean assertItems(int expectedItemsNumber) {
        return Assertions.assertEquals("Number of items", expectedItemsNumber, this.getEventsRows().size());
    }
    ...
    public List<WebElement> getFollowButton() {
